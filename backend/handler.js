...
module.exports.getCompletedItems = (event, context, callback) => {
  ...
  // https://www.infoq.com/articles/mars-rover-application-DynamoDB https://github.com/awslabs/aws-dynamodb-mars-json-demo/blob/master/viewer/app/scripts/services/mars-photos.js#L19-L40
  db.scan({
    TableName: CLOSED_ITEMS_TABLE,
  }, function(err, items) {
    if (err) return callback(err)
